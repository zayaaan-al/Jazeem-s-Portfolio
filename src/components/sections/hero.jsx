                    ...
                    <div className="col-lg-4">
                        <SlideUp>
                            <div className="about-image-part">
                                ...
                                <h2>Jazeem M</h2>
                                <p>I’m Jazeem, a Video Editor & Content Creator crafting cinematic and engaging visual stories.</p>
                    ...
                    <div className="col-lg-8">
                        <SlideUp>
                            <div className="about-content-part">
                                <p>Hello There!</p>
                                <h2>
I’m Jazeem, a Video Editor & Content Creator crafting cinematic and engaging visual stories.                                </h2>
